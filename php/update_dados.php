<?php
	...
	if ($query_select->num_rows>0) { 
		$update="UPDATE `tb_dadoscliente` SET `nome_dadosC`='$nome_dados',`telefone_dadosC`='$telefone_dados',`rg_dadosC`='$rg_dados',`dt_nasc_dadosC`='$data_nasc_dados',`pedido_venda`='$pedido',`responsavel`='$resp' WHERE cod_dadosC=$id_user";
		...
		$insert_da="insert into tb_dadoscliente (cod_dadosC,login_dadosC,nome_dadosC,telefone_dadosC,rg_dadosC,dt_nasc_dadosC,pedido_venda,responsavel) values ($id_user,'$email_user','$nome_dados','$telefone_dados', $rg_dados ,'$data_nasc_dados','$pedido','$resp')";
