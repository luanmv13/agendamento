	...
	<div id="container-agen">
      ...
      <?php
        if(isset($_SESSION['logado'])==true AND $_SESSION['logado']>0){
          ...
          $pedido=$row_busca['pedido_venda'];
          $resp=$row_busca['responsavel'];
        ...
        <div id="div-ag" class="bk-azul-escuro box-s">
          <h2 class="color-white"><i class="far fa-calendar-alt" style="margin-right: 6px; font-size: 24px;"></i> Agendamento</h2>
            ...
            <form id="form_dados" method="post" action="">
              ...
              <div> <!-- inline/dois inputs na mesma linha -->
                <div style="width: 50%; float: left;">
                  <label>N° Pedido de Vendas</label><br>
                    <?php echo '<input type="text" name="pedido_venda" maxlength="9" value="'.$row_busca['pedido_venda']. '" required style="width: 110px;"> '; ?>
                </div>
                <div style="width: 50%; float: left;">
                  <label>Responsavel pela Retirada</label><br>
                    <?php echo '<input type="text" name="responsavel" value="'.$row_busca['responsavel'].'" required style="width: 140px; padding: 6px;">' ; ?>
                </div>
              </div>
